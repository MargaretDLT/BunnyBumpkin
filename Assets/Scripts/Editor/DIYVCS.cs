...
public class DIYVCS : EditorWindow
{
	...
	public static void exportPackage()
	{
		...
		{
			projectContent = new string[] { "Assets", "ProjectSettings", "Packages/manifest.json", "Packages/packages-lock.json" };
		}
		else
		{
			...
			else
			{
				...
				{
					projectContent = new string[] { "Assets", "Packages/manifest.json", "Packages/packages-lock.json" };
				}
				else
				{
